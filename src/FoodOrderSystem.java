...
public class FoodOrderSystem {
    ...
    public void startOrdering(Scanner scanner) {
        ...
        while (ordering) {
            System.out.println("What type of food would you like? (pizza, sushi, burgers)");
            ...
            switch (foodType) {
                ...
                case "burgers":
                    ...
                    break;
                default:
                    System.out.println("Invalid choice. Please select from pizza, sushi, or burgers.");
            }
    ...
    private void orderPizza(Scanner scanner) {
        System.out.println("What type of pizza would you like? (sausage, pepperoni, veggie)");
